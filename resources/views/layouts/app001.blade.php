...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <a href="{{ route('users.index') }}" class="nav-item nav-link"><i class="fa fa-user me-2"></i>Quản
                    lý tài
                    khoản</a>
                <a href="{{ route('books.index') }}" class="nav-item nav-link"><i class="fa fa-book me-2"></i>Quản lý
                    sản phẩm</a>
                <a href="{{ route('invoices.index') }}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Quản
                    lý hóa đơn</a>
        ...
        <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
            ...
            <div class="navbar-nav align-items-center ms-auto">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                        <a href="{{ route('detail.index', Auth::user()->id) }}" class="dropdown-item">Thông tin cá
                            nhân</a>
    ...
    <!-- Back to Top -->
    <a href="#" class="btn btn-lg bscripttn-primary btn-lg-square back-to-top"><i
